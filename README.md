...
We evaluate Qwen 2.5 models (0.5B, 3B, 7B, 32B parameters) on binary sequences generated by BrainPhoque programs (a Universal Turing Machine implementation). By measuring predictive log-loss as more bits are revealed, we test whether:
...
See `results/brainphoque_qwen/plots/comparison/` for the final plots.
...
│   ├── generate_brainphoque_binary_data.py    # Generate BrainPhoque sequences
│   ├── llm_brainphoque_binary_qwen.py         # Evaluate LLMs on sequences
│   ├── plot_multiple_models_token_loss.py     # Plot loss over position
│   └── plot_multiple_models_regret.py         # Plot regret vs complexity
├── data/                         # Data generation utilities
│   └── utms.py                   # BrainPhoque UTM implementation
├── results/                      # Experimental results
│   └── brainphoque_qwen/         # Qwen model evaluation results
...
See `results/brainphoque_qwen/README.md` for detailed usage instructions and examples.
